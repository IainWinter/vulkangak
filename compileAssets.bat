...
glslc .\src_assets\shaders\text_msdf\text_msdf.vert -o .\build\shaders\text_msdf_vert.spv
glslc .\src_assets\shaders\text_msdf\text_msdf.frag -o .\build\shaders\text_msdf_frag.spv
